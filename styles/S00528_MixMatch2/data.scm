...
(define overlays-layout-seq
  (shuffled-sequence
    '(list (list (overlay) (corner) (corner) -0.05 (rand 0.25 0.35) () (rand -30.0 30.0)))
    '(list (list (overlay) (corner) (corner) -0.05 (rand 0.25 0.35) () (rand -30.0 30.0)))
    '(list (list (overlay) top      left     -0.05 (rand 0.25 0.35) () (rand -30.0 30.0))
           (list (overlay) bottom   right    -0.05 (rand 0.25 0.35) () (rand -30.0 30.0)))
    '(list (list (overlay) top      right    -0.05 (rand 0.25 0.35) () (rand -30.0 30.0))
           (list (overlay) bottom   left     -0.05 (rand 0.25 0.35) () (rand -30.0 30.0)))))
