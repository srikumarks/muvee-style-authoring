...
(style-parameters
  ...
  (one-of-few		OVERLAYS	Overlays1	(Overlays1  Overlays2)))
...
(define overlays1-layout-seq
  (shuffled-sequence
    '(list (list (overlay) top    left  -0.05 (rand 0.15 0.2) () (rand 0.0 360.0))
           (list (overlay) bottom right -0.05 (rand 0.15 0.2) () (rand 0.0 360.0)))
    '(list (list (overlay) top    left  -0.05 (rand 0.15 0.2) () (rand 0.0 360.0))
           (list (overlay) bottom right -0.05 (rand 0.15 0.2) () (rand 0.0 360.0)))
    '(list (list (overlay) top    right -0.05 (rand 0.15 0.2) () (rand 0.0 360.0))
           (list (overlay) bottom left  -0.05 (rand 0.15 0.2) () (rand 0.0 360.0)))
    '(list (list (overlay) top    right -0.05 (rand 0.15 0.2) () (rand 0.0 360.0))
           (list (overlay) bottom left  -0.05 (rand 0.15 0.2) () (rand 0.0 360.0)))
    '(list (list (overlay) top    left  -0.05 (rand 0.15 0.2) () (rand 0.0 360.0))
           (list (overlay) top    right -0.05 (rand 0.15 0.2) () (rand 0.0 360.0))
           (list (overlay) bottom left  -0.05 (rand 0.15 0.2) () (rand 0.0 360.0))
           (list (overlay) bottom right -0.05 (rand 0.15 0.2) () (rand 0.0 360.0)))))

(define overlays2-layout-seq
  (shuffled-sequence
    '(list (list (overlay "02") top    center 0.05 0.25 () (rand   -8.0   8.0))
           (list (overlay "03") bottom center 0.00 0.35 () (rand   -4.0   4.0)))
    '(list (list (overlay "01") center left   0.05 0.30 () (rand  -98.0 -82.0))
           (list (overlay "04") center right  0.05 0.25 () (rand  -98.0 -82.0)))
    '(list (list (overlay "10") top    left   0.05 0.30 () (rand -110.0 -70.0))
           (list (overlay "09") bottom right  0.05 0.30 () (rand -110.0 -70.0)))
    '(list (list (overlay "07") top    right  0.05 0.40 () (rand   20.0  40.0))
           (list (overlay "08") bottom left   0.05 0.70 () (rand  -95.0 -85.0)))
    '(list (list (overlay "10") top    left   0.05 0.30 () (rand -110.0 -70.0))
           (list (overlay "06") top    right  0.05 0.30 () (rand -100.0 -80.0))
           (list (overlay "05") bottom left   0.05 0.30 () (rand   70.0 110.0))
           (list (overlay "09") bottom right  0.05 0.30 () (rand -110.0 -70.0)))))
...
(title-section
  ...
  (text
    (align 'center 'center)
    (color 118 61 36)
    (font "-20,0,0,0,800,0,0,0,0,3,2,1,34,Arial Black")
