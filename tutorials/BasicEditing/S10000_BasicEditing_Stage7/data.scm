...
;
; Here we add a new slider to control the amount of music
; response displayed by the style. We not only want to go
; from "no response" to "maximum response", but also wish
; to be a quirky and allow "inverse response" characteristics
; - i.e. these will make the style edit slower when the music is
; more energetic and faster when the music is soft :-D
; =================================================================
