...
; STAGE 8 : Some polish.
;
; This stage tells you how to specify transitions between
; the title section and the muvee and between the muvee
; and the credits section. You also learn to add support
; for captions.
; =================================================================
