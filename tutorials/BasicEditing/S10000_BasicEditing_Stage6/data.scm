...
;
; Usually, you want to make shorter transitions when the music
; is very energetic and longer ones when the music is soft.
; Here we setup the "transition duration transfer curve" that
; lets you control this aspect of a style.
; =================================================================
